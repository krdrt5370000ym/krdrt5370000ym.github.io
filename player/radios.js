...
function siteRadio(streamUrl) {
   ...
   fetch("https://krdrt5370000ym.github.io/player/json/site.json")
      .then(res => res.json())
      .then(json => {
...
function openStreamLink(streamUrl) {
   ...
   fetch("https://krdrt5370000ym.github.io/player/json/openstreamlink.json")
      .then(res => res.json())
      .then(json => {
         // Zmiana na json.site zgodnie z Twoją sugestią
...
function playlistNowPlaying(streamUrl) {
   ...
   const updateTrack = () => {
      fetch("https://krdrt5370000ym.github.io/player/json/playlist.json")
         .then(res => res.json())
         .then(json => {
