         ...
         return `
                <div class="articles_posts">
                    <article id="post-${post.id}">
                        ...
                        ${imageDisplay}
                        <div class="article_singlecontent_posts">${is_cors ? post.content.rendered.replace('src=\"http','src=\"https://cors.krdrt5370000ym2.workers.dev/?url=http') : post.content.rendered}</div>
                    </article>
                </div>`;
      });
