   ...
   PODCASTS
      ...
      .forEach(p => {
         ...
         const thumbnailDisplay = p.thumbnail_uri ?
            `<img decoding="async" src="https://image.krdrt5370000ym2.workers.dev/?url=${encodeURIComponent('https://' + p.thumbnail_uri)}&w=500&h=500&q=75&d=1" alt="${escapeHTML(p.name)}">` : "";
