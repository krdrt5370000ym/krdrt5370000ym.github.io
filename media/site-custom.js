async function WPCustom(
   ...
   try {
      ...
      const articlesHtml = posts.map(post => {
         ...
         const imageDisplay =
            is_image && imgUrl ?
            `<img src="https://image.krdrt5370000ym2.workers.dev/?url=${encodeURIComponent(imgUrl)}&w=500&h=500&q=75&d=1" width="150" height="150" alt="${imgUrl}" style="object-fit:cover;" alt="">` : '';
...
async function WPCustomList(
   ...
   try {
      ...
      const postsHTML = posts.map(post => {
         ...
         const imageHTML =
            (is_image && imgUrl) ?
            `<img src="https://image.krdrt5370000ym2.workers.dev/?url=${encodeURIComponent(imgUrl)}&w=500&h=500&q=75&d=1" width="150" height="150" alt="${imgUrl}" style="object-fit:cover;" loading="lazy">` :'';
