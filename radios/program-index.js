...
async function uruchomProgram() {
   ...
   try {
      ...
      const thumbnailText = thumb ?
         ...
         (program.thumbnail_uri ? `<img src="https://image.krdrt5370000ym2.workers.dev/?url=${encodeURIComponent(program.thumbnail_uri)}&w=500&h=500&q=75&d=1" alt="${escapeHTML(program.name)}">` : "");
